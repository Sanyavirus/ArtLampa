...
namespace DomMezonin.DomainModel.Repository
{
    public class FakeProductRepository : IRepository<Product>
    {
        ...
        public bool CreateEntity(EntityBase entity)
        {
            throw new NotImplementedException();
        }

        public bool UpdateEntity(EntityBase entity)
        {
            throw new NotImplementedException();
        }
        ...
        public bool CreateEntities(IEnumerable<EntityBase> entity)
        {
            throw new NotImplementedException();
        }

        public bool UpdateEntities(IEnumerable<EntityBase> entity)
        {
            throw new NotImplementedException();
        }

        public bool DeleteEntities(IEnumerable<EntityBase> entity)
        {
            throw new NotImplementedException();
        }
    }
